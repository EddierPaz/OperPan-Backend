...
// ============================================================
// RENDERIZAR DETALLE DE PERMISO (ADMIN)
// ============================================================
...
// ============================================================
// RENDERIZAR DETALLE DE INCAPACIDAD (ADMIN)
// ============================================================
...
// ============================================================
// RENDERIZAR DETALLE DE CERTIFICADO (ADMIN)
// ============================================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function activateTab(tab) {
        ...
        // Ejecutar funciones de carga según pestaña
        switch(tabName) {
            case 'permisos':
                if (typeof window.cargarPermisos === 'function') window.cargarPermisos();
                break;
            case 'incapacidades':
                if (typeof window.cargarIncapacidades === 'function') window.cargarIncapacidades();
                break;
            case 'certificados':
                if (typeof window.cargarCertificados === 'function') window.cargarCertificados();
                break;
            case 'memorandos':
                if (typeof window.cargarMemorandos === 'function') window.cargarMemorandos();
                break;
        }
    }
